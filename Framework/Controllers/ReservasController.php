...
class ReservasController
{
    ...
    public function VerReservasDueno($alert = null)
    { //CHECKED
            ...
            try {
                ...
                if ($reserva) {
                    ...
                    switch ($checkTipoEstadia) {
                        ...
                        case 2:
                            throw new Exception("Esta mascota ya tiene una reserva en ese rango de fecha");
                            break;
                    }
                } else {
                ...
                if ($listaReservas) {
                    ...
                    foreach ($listaReservas as $reservaEnRango) {
                        ...
                        if ($mascota->getRaza() != $mascotaTemp->getRaza()) {
                            ...
                            $resultado = 1;
                        } else if ($reserva->getDueño() == $reservaEnRango->getDueño() and $reserva->getMascota() == $reservaEnRango->getMascota()) {
    ...
    private function EnviarMailAceptacion(Reserva $reserva)
    {
        ...
        if (isset($_SESSION["UserId"]) and $_SESSION["Tipo"] == "G") {
            ...
            try {
                ...
                $mail->Password = 'tpqwxfmumtguirdx';                           // SMTP password
